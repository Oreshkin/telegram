package com.epam.training.telegram.bot.oreshkin;
...
import com.epam.training.telegram.bot.oreshkin.updateshandlers.BotHandlers;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try {
                ...
                telegramBotsApi.registerBot(new BotHandlers());
